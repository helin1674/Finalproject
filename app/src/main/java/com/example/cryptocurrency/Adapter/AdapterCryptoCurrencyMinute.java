...
public class AdapterCryptoCurrencyMinute extends  RecyclerView.Adapter {

    Context context;
    List<AllMinuteCryptoCurrency> listAllMinuteCrypto;
    ...
    public AdapterCryptoCurrencyMinute(Context context, List<AllMinuteCryptoCurrency> body,@NonNull OnItemClickListener onItemClickListener) {
